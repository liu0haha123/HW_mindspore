...
from dataset import Dataset_DBPN_Eval, Dataset_DBPN
...
def get_training_set(data_dir, hr, upscale_factor, patch_size, data_augmentation):
    ...
    return Dataset_DBPN(hr_dir,patch_size, upscale_factor, data_augmentation)


def get_eval_set(lr_dir, upscale_factor):
    return Dataset_DBPN_Eval(lr_dir, upscale_factor)
