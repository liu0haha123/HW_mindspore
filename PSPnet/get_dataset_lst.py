...
#
#
VOC_IMG_DIR = os.path.join(data_dir, 'VOC2012/JPEGImages')
VOC_ANNO_DIR = os.path.join(data_dir, 'VOC2012/SegmentationClass')
VOC_ANNO_GRAY_DIR = os.path.join(data_dir, 'VOC2012/SegmentationClass')
VOC_TRAIN_TXT = os.path.join(data_dir, 'VOC2012/ImageSets/Segmentation/train.txt')
VOC_VAL_TXT = os.path.join(data_dir, 'VOC2012/ImageSets/Segmentation/val.txt')
...
def create_voc_train_lst_txt():
    ...
    with open(VOC_TRAIN_LST_TXT, mode='w') as f:
        for id_ in voc_train_data_lst:
            ...
            anno_ = os.path.join(VOC_ANNO_DIR, id_ + '.png')
            f.write(img_ + ' ' + anno_ + '\n')
...
def create_voc_train_aug_lst_txt():
    ...
    with open(VOC_AUG_TRAIN_LST_TXT, mode='w') as f:
        for id_ in sbd_train_data_lst + sbd_val_data_lst:
            ...
            anno_ = os.path.join(SBD_ANNO_DIR, id_ + '.png')
            f.write(img_ + ' ' + anno_ + '\n')
