...
from src.utils.metrics import eval_semantic_segmentation
...
def parse_args(cloud_args=None):
    ...
    parser.add_argument('--num_classes', type=int, default=150, help='number of classes')
    parser.add_argument('--ckpt_path', type=str,
                        default='./checkpoints/ADE_2-12_631.ckpt', help='eval data dir')
    parser.add_argument('--scales', type=float,default=[1.0,1.0,1.0], action='append',help='scales of evaluation')
...
def test():
    ...
    if bi > 0:
        batch_res = eval_batch_scales(args, eval_net, batch_img_lst, scales=args_opt.scales,
                                      base_crop_size=args_opt.crop_size, flip=args_opt.flip)
        for mi in range(bi):
